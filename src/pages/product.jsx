...
const Product = () => {
  ...
  return <div>
    ...
    <div>
      ...
      {/* Shop Detail Start */}
      {loading ? <Loader /> : <div className="container-fluid py-5">
        <div className="row px-xl-5">
          ...
          <div className="col-lg-7 pb-5">
            ...
            <h3 className="font-weight-semi-bold mb-4"><del>₹ {product.mrp_price}</del></h3>
            <h3 className="font-weight-semi-bold mb-4">₹ {product.sale_price}</h3>
